...
- **Language** — Speak in `English`, tailored to `intermediate`. Write files in `English`.
...
- `draft` → `C:\Users\joshe\Documents\game-note-py\_bmad\render\bmad-build-auto\game-note-py-e8af91dfec7c\20dfea06c8ae298bf0fd\step-02-plan.md`
- `ready-for-dev` or `in-progress` → `C:\Users\joshe\Documents\game-note-py\_bmad\render\bmad-build-auto\game-note-py-e8af91dfec7c\20dfea06c8ae298bf0fd\step-03-implement.md`
- `in-review` → `C:\Users\joshe\Documents\game-note-py\_bmad\render\bmad-build-auto\game-note-py-e8af91dfec7c\20dfea06c8ae298bf0fd\step-04-review.md`
- `blocked` → HALT with status `blocked` and blocking condition `blocked spec supplied`.
- `done` → set `review_loop_iteration` to `0` in the frontmatter and set `followup_pass` to `true`, then **EARLY EXIT** to `C:\Users\joshe\Documents\game-note-py\_bmad\render\bmad-build-auto\game-note-py-e8af91dfec7c\20dfea06c8ae298bf0fd\step-04-review.md` for a fresh review pass. (A `done` spec is a completed run, so this starts a follow-up review, not a resumption.)
...
1. Load context.
   - List files in `C:\Users\joshe\Documents\game-note-py/_bmad-output/planning-artifacts` and `C:\Users\joshe\Documents\game-note-py/_bmad-output/implementation-artifacts`.
   ...
   - **Determine context strategy.** Using the intent and the artifact listing, infer whether the current work is a story from an epic. Do not rely on filename patterns or regex — reason about the intent, the listing, and any epics file content together.
     ...
     **A) Epic story path** — if the intent is clearly an epic story:
     ...
     3. **Compile epic context if needed.** If no valid cached epic context was loaded, produce `C:\Users\joshe\Documents\game-note-py/_bmad-output/implementation-artifacts/epic-<N>-context.md` by spawning a subagent synchronously with `C:\Users\joshe\Documents\game-note-py\_bmad\render\bmad-build-auto\game-note-py-e8af91dfec7c\20dfea06c8ae298bf0fd\compile-epic-context.md` as its prompt. Pass it the epic number, epics file path, `C:\Users\joshe\Documents\game-note-py/_bmad-output/planning-artifacts`, and output path `C:\Users\joshe\Documents\game-note-py/_bmad-output/implementation-artifacts/epic-<N>-context.md`.
