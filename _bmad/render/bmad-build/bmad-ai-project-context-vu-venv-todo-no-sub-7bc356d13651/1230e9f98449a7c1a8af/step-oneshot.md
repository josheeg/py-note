...
If `{story_key}` is not empty and `C:\Users\joshe\Documents\bmad-ai-project-context-vu-venv-todo-no-sub/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `C:\Users\joshe\Documents\bmad-ai-project-context-vu-venv-todo-no-sub\_bmad\render\bmad-build\bmad-ai-project-context-vu-venv-todo-no-sub-7bc356d13651\1230e9f98449a7c1a8af\sync-sprint-status.md` with `{target_status}` = `in-progress`.
...
If a layer needs subagents and you cannot launch them, write the full prompt for each layer under `C:\Users\joshe\Documents\bmad-ai-project-context-vu-venv-todo-no-sub/_bmad-output/implementation-artifacts` (with placeholders filled in, not just file paths). Stop and ask the user to run each prompt in a separate session and paste back the findings.
...
If `{story_key}` is not empty and `C:\Users\joshe\Documents\bmad-ai-project-context-vu-venv-todo-no-sub/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `C:\Users\joshe\Documents\bmad-ai-project-context-vu-venv-todo-no-sub\_bmad\render\bmad-build\bmad-ai-project-context-vu-venv-todo-no-sub-7bc356d13651\1230e9f98449a7c1a8af\sync-sprint-status.md` with `{target_status}` = `review`.
